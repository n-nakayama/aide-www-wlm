...
class apiCreateApp extends apiIndex {
	...
	private function createForm($request) {
		...
		$view->addColumnItems("layerid", "$layerid");
		...
		$view->addColumnItems("stackid", "$stackid");
		$view->addColumnItems("layerid", "$layerid");
		$view->addColumnItems("instanceid", "$instanceid");
		$view->addColumnItems("appid", "$appid");
		$view->addColumnItems("deployid", "$deployid");
