...
class apiListResourceEvents extends apiIndex {
	public static $APIURL = "/stacks/%stackname%/%stackid%/resources/%resourcename%/events";
	...
	public function exec($request = array()) {
		try{
			...
			$urlitems = array(
				...
				"resourcename" => (isset($resourcename) ? $resourcename : ""),
			);
			//cfn api
